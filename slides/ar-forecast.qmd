...
The parameters *aren't* known. They're a noisy estimate computed from imperfect data. There is sampling uncertainty associated with $\hat{\Btheta}$. Shouldn't that extra source of uncertainty be propagated through to the predictive distribution?

. . .

You bet. But how? Can we just replace $z$ quantiles with $t$ quantiles?
...
Jabber about bootstrap

## Show them some code they could actually use
...
you get student's t for 1 step, which begets intervals and densities and points
