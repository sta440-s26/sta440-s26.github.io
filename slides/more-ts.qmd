...
$$
\begin{matrix}
  \cdots & \to & y_1 & \to & y_2 & \to & y_3 & \to & y_4 & \to &\cdots \\
   & \nearrow & \uparrow & \nearrow & \uparrow & \nearrow & \uparrow & \nearrow & \uparrow &  &  \\
...
fc$pred # point prediction

fc$se # predictive standard error
```
...
$$
y_t=s_t+\varepsilon_t,\quad \varepsilon_t\indep\N(0\com \sigma^2).
$$
:::
